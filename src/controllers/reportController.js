...
exports.generateOrderReport = async (req, res) => {
  try {
    ...
    // --- Logging ---
    logger.info(`Order report generated with ${orders.length} records.`, { filters: req.query });
    ...
    // --- Logging ---
    logger.error(`Failed to generate order report: ${error.message}`, { filters: req.query });
